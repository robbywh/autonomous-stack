...
cd apps/mobile && bunx skills add PatternsDev/skills/react --all && bunx skills add expo/skills --all && cd ../..
```
...
cd apps/web && bunx skills add PatternsDev/skills/react --all && cd ../..
```
...
cd apps/backend && bunx skills add PatternsDev/skills/javascript --all && cd ../..
```
